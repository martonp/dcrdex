...
func (u *unifiedExchangeAdaptor) cexCounterRates(cexBuyLots, cexSellLots uint64, multiHopCfg *MultiHopCfg) (dexBuyRate, dexSellRate uint64, err error) {
	...
	tryLots := func(b, s uint64) (uint64, uint64, bool, error) {
		...
		buyRate, filled, err := arbMMExtrema(false, lotSize*s, multiHopCfg, u.market, u.CEX.VWAP, u.CEX.InvVWAP)
		if err != nil {
		...
		sellRate, filled, err := arbMMExtrema(true, lotSize*b, multiHopCfg, u.market, u.CEX.VWAP, u.CEX.InvVWAP)
		if err != nil {
