...
var EnUS = map[string]string{
	...
	"split_tx_allowed":            "Split Tx Allowed",
	"split_tx_allowed_tooltip":    "UTXO based assets may need to occasionally do a split transaction to be able to fund all of the placements. The wallets are optimized to do as few split transactions as possible. If this is unchecked, all of your placements may not be able to be funded.",
	"split_tx_buffer":             "Split Tx Buffer",
	"split_tx_buffer_tooltip":     "The amount of buffer to add to the outputs of split transactions of the quote asset. As the price moves up, a higher amount of the quote asset will be needed to fund the same amount of lots. If there was a sufficient buffer, the output for the previous unmatched order can be reused.",
	...
	"logs":                        "Logs",
	"market_maker_logs":           "Market Maker Logs",
	"past_mm_runs":                "Past Market Maker Runs",
	"load_logs":                   "Load Logs",
	"view_logs":                   "View Logs",
	"past_run_logs":               "Past Run Logs",
