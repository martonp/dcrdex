...
export const ID_CONNECTED_VIA_BACKUP_ENDPOINT = 'CONNECTED_VIA_BACKUP_ENDPOINT'
export const ID_DUPLICATE_SERVER_ENDPOINT_MSG = 'DUPLICATE_SERVER_ENDPOINT_MSG'
