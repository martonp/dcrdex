...
export default class MarketMakerSettingsPage extends BasePage {
  ...
  async updateAllocations () {
    ...
    if (this.runningBot) {
      ...
      toAlloc = toAllocateRunning(totalBuyLots, totalSellLots, slippageBuffer, buyFeeReserve, sellFeeReserve, perBuyLot, perSellLot,
      ...
      toAlloc = toAllocate(totalBuyLots, totalSellLots, slippageBuffer, buyFeeReserve, sellFeeReserve, perBuyLot, perSellLot,
        this.marketReport, availableFunds, canRebalance, baseID, quoteID, baseFeeAssetID, quoteFeeAssetID,
  ...
  enableRebalanceChanged () {
    ...
    const { updatedConfig: cfg } = this
    cfg.uiConfig.cexRebalance = page.enableRebalance.checked ?? false
    this.updateAllocations()
  }
  ...
  async doSave () {
    ...
    let autoRebalanceCfg: AutoRebalanceConfig | undefined
    ...
    if (this.runningBot) await MM.updateRunningBot(botCfg, updatedAllocation, autoRebalanceCfg)
