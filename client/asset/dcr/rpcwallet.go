...
// transaction. The second return value is true if the transaction is a mix
// (funds went from unmixed to mixed account), false if the transaction is an
// unmix (funds went from mixed to unmixed account, which happens when mixing
// is disabled).
